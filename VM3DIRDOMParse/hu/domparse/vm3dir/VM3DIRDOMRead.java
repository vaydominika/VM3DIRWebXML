    ...
    public static void main(String[] args) throws SAXException, IOException, ParserConfigurationException, TransformerException {
        ...
        try {
            ...
            for (int i = 0; i < orokbefogadasList.getLength(); i++) {
                ...
                if (nNode.getNodeType() == Node.ELEMENT_NODE) {
                    Element elem = (Element) nNode;
                    // Az örökbefogadásnak nincs ID-ja, csak a macska_ref és orokbefogado_ref kombinációja azonosítja
                    System.out.println("Örökbefogadás (Macska: " + elem.getAttribute("macska_ref") + 
                                      ", Örökbefogadó: " + elem.getAttribute("orokbefogado_ref") + ")");
                    System.out.println("Macska ref: " + elem.getAttribute("macska_ref"));
            ...
            // XML tartalom fájlba írása (külön XML fájlba) - UTF-8 kódolással
            File xmlOutputFile = new File("VM3DIRDOMParse/hu/domparse/VM3DIRDOMRead_output.xml");
            OutputStreamWriter xmlFileWriter = new OutputStreamWriter(
                new FileOutputStream(xmlOutputFile), StandardCharsets.UTF_8);
            StreamResult xmlFileResult = new StreamResult(xmlFileWriter);
            transformer.setOutputProperty(javax.xml.transform.OutputKeys.ENCODING, "UTF-8");
            transformer.transform(source, xmlFileResult);
            xmlFileWriter.close();
            
            System.out.println("\n\nXML tartalom kiírva fájlba: " + xmlOutputFile.getAbsolutePath());
